...
# removing headers, quotes, extracting useful columns, reducing coordinate floats
...
echo ""
echo "i file cng.csv ed lpg.csv sono pronti per essere joined a tmp/short_$ANAGRAFICA.csv con openrefine"
...
echo "per esportare in json vedi: operefine_export.template"
echo "eventualmente togli i valori nulli prima della conflation:"
